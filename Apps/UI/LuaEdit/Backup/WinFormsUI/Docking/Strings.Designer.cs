...
namespace WeifenLuo.WinFormsUI.Docking {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Indicate whether or not the status icon should be displayed..
        /// </summary>
        internal static string DockContent_ShowStatusIcon_Description {
            get {
                return ResourceManager.GetString("DockContent_ShowStatusIcon_Description", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Status icon displayed when ShowStatusIcon property is set to true..
        /// </summary>
        internal static string DockContent_StatusIcon_Description {
            get {
                return ResourceManager.GetString("DockContent_StatusIcon_Description", resourceCulture);
            }
        }
