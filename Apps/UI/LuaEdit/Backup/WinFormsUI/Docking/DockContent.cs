...
namespace WeifenLuo.WinFormsUI.Docking
{
	public class DockContent : Form, IDockContent
	{
        ...
        [LocalizedCategory("Category_Docking")]
        [LocalizedDescription("DockContent_ShowStatusIcon_Description")]
        [DefaultValue(false)]
        public bool ShowStatusIcon
        {
            get { return DockHandler.ShowStatusIcon; }
            set { DockHandler.ShowStatusIcon = value; }
        }

        [LocalizedCategory("Category_Docking")]
        [LocalizedDescription("DockContent_StatusIcon_Description")]
        [DefaultValue(null)]
        public Icon StatusIcon
        {
            get { return DockHandler.StatusIcon; }
            set { DockHandler.StatusIcon = value; }
        }
