namespace LuaInterface 
{
    ...
    [Flags]
    public enum LuaHookMasks : int
    {
        LUA_MASKCALL = 1 << LuaHooks.LUA_HOOKCALL,
        LUA_MASKRET = 1 << LuaHooks.LUA_HOOKRET,
        LUA_MASKLINE = 1 << LuaHooks.LUA_HOOKLINE,
        LUA_MASKCOUNT = 1 << LuaHooks.LUA_HOOKCOUNT
    }
    ...
    public struct LuaDebug
    {
        ...
        public string NameWhat;                     /* (n) */
        [FieldOffset(12), MarshalAs(UnmanagedType.LPStr)]
        public string What;                         /* (S) */
        ...
        [FieldOffset(36), MarshalAs(UnmanagedType.ByValTStr, SizeConst = 60)] 
    ...
    /*
	 * Delegate for debug hooks
	 */
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int LuaHookFunction(IntPtr luaState, IntPtr ar);
	...
	public static class LuaDLL 
	{
		...
		const string LUADLL = BASEPATH + "lua51.dll";		// steffenj: use Lua 5.1.4 dll
		const string LUALIBDLL = BASEPATH + "lua51.dll";	// steffenj: use Lua 5.1.4 dll
        const string STUBDLL = BASEPATH + "luanet.dll";

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern LuaHookFunction lua_gethook(IntPtr luaState);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int lua_gethookcount(IntPtr luaState);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern LuaHooks lua_gethookmask(IntPtr luaState);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int lua_getinfo(IntPtr luaState, string what, IntPtr ar);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern string lua_getlocal(IntPtr luaState, IntPtr ar, int n);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int lua_getstack(IntPtr luaState, int level, IntPtr ar);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern string lua_setlocal(IntPtr luaState, IntPtr ar, int n);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        ...
        public static string lua_tostringex(IntPtr luaState, int index)
        {
            LuaTypes valType = lua_type(luaState, index);
            ...
            switch (valType)
            {
                ...
                case LuaTypes.LUA_TTABLE: // todo for tables: recursive parsing for smart printing
                    {
                        retVal = lua_tostring(luaState, index);
                        break;
                    }
                case LuaTypes.LUA_TBOOLEAN:
                    {
                        retVal = lua_toboolean(luaState, index) ? "true" : "false";
                        break;
                    }
                case LuaTypes.LUA_TFUNCTION:
                    {
                        retVal = string.Format("FUNC:{0}", lua_topointer(luaState, index).ToInt32());
                        break;
                    }
                case LuaTypes.LUA_TUSERDATA:
                    {
                        retVal = string.Format("USERDATA:{0}", lua_topointer(luaState, index).ToInt32());
                        break;
                    }
                case LuaTypes.LUA_TLIGHTUSERDATA:
                    {
                        retVal = string.Format("LIGHTUSERDATA:{0}", lua_topointer(luaState, index).ToInt32());
                        break;
                    }
                case LuaTypes.LUA_TTHREAD:
                    {
                        retVal = string.Format("THREAD:{0}", lua_tothread(luaState, index).ToInt32());
                        break;
                    }
            }
